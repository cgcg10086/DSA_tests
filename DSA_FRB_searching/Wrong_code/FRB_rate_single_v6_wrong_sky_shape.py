...
my_DM_min = 0.0 
my_DM_max = 5000.0
my_sky_angle = 5.0 # radius of the circle to integrate (in degree) 
my_beam_forming_integral = Beam_forming_2D_int(my_sky_angle)  

'''
For test: enable this block if want muiltiple time resolutions and channel numbers. 
...
time_resolution = [0.131073] # in ms 
