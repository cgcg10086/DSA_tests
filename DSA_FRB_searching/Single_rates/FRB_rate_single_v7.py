...
# -*- coding: utf-8 -*-
"""
Created on Fri Sept 4 
FRB_rate_single_v7.py: computes the detection rate % 
@author: gechen
...
my_theta_x = np.linspace(-1 * my_img_size, my_img_size,num=plot_num, endpoint=False)
my_theta_y = np.linspace(-1 * my_img_size, my_img_size,num=plot_num, endpoint=False)
my_theta_x_edges = np.linspace(-1 * my_img_size, my_img_size,num=plot_num, endpoint=True)
my_theta_y_edges = np.linspace(-1 * my_img_size, my_img_size,num=plot_num, endpoint=True)
...
fig1.savefig('Prime_2D_'+str(my_img_size)+'.pdf')  
